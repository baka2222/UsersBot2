...
# Вложенные сценарии в карточке группы создают много служебных полей формы.
# Стандартный лимит Django (1000 полей) обрывал сохранение большой группы с
# пустым HTTP 400 ещё до валидации админки.  Файлы по-прежнему отдельно
# ограничиваются валидатором модели до 10 МБ.
